...
models = st.sidebar.selectbox("Car Model: ", ('GT86', 'Corolla', 'RAV4', 'Yaris', 'Auris', 'Aygo', 'C-HR',
...
years = st.slider("Model Year: ", 1998, 2024)
Year = {'1998': 0, '1999': 1, '2000': 2, '2001': 3, '2002': 4, '2003': 5, '2004': 6, '2005': 7, '2006': 8, '2007': 9, 
        ...
        '2018': 20, '2019': 21, '2020': 22, '2021': 23, '2022': 24, '2023': 25, '2024': 26}
if years:
  year = Year[str(years)]

Trans = st.sidebar.selectbox("Enter Transmission: ", ('manual', 'automatic', 'semi-auto', 'other'))
transmission = {'manual': 1, 'automatic': 0, 'semi-auto': 3, 'other': 2}
if Trans:
  trans = transmission[Trans]

Fuel = st.sidebar.selectbox("Enter FuelType: ", ('Petrol', 'Other', 'Hybrid', 'Diesel'))
fuelType = {'Petrol': 3, 'Other': 2, 'Hybrid': 1, 'Diesel': 0}
if Fuel:
  fuel = fuelType[Fuel]

mile = form.text_input("Enter MileAge (Km): ")
tax = form.text_input("Enter Tax ($): ")
mpg = st.slider("Enter Miles per Gallon (litres): ", 2.8, 235.0)
engSize = st.slider("Enter EngineSize (litre): ", 0.0, 4.5)

submit = form.form_submit_button("Check Price")
